...
@Service
public class JwtAuthenticationProvider implements JwtProvider {
    @Autowired
    ...
    public Authentication validate(String token) {
        ...
        GrantedAuthority role = new SimpleGrantedAuthority(String.valueOf(claims.get("role")));
        Authentication auth = new UsernamePasswordAuthenticationToken(email, null, List.of(role));
        return auth;
    }
}
